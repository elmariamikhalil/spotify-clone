      ...
      <PlayerProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/liked" element={<PrivateRoute><Layout><LikedSongs /></Layout></PrivateRoute>} />
            <Route path="/playlist/:id" element={<PrivateRoute><Layout><PlaylistDetail /></Layout></PrivateRoute>} />
            <Route path="/history" element={<PrivateRoute><Layout><History /></Layout></PrivateRoute>} />
            <Route path="/settings" element={<PrivateRoute><Layout><Settings /></Layout></PrivateRoute>} />
            
            <Route path="/artist" element={<PrivateRoute roles={['artist']}><Layout><ArtistDashboard /></Layout></PrivateRoute>} />
            <Route path="/artist/upload" element={<PrivateRoute roles={['artist']}><Layout><UploadSong /></Layout></PrivateRoute>} />
            <Route path="/artist/albums" element={<PrivateRoute roles={['artist']}><Layout><Albums /></Layout></PrivateRoute>} />
